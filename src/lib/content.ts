...
/**
 * Insurance & corporate health network partners. Sourced from the clinic's
 * official partner posters. Names kept verbatim so the marquee renders the
 * same text users see on physical posters / social media. Order is shuffled
 * loosely so big-brand recognition is spread evenly across the two rows.
 */
